            ...
            <div class="card-body">
                <form id="update-fund-form" class="container-fluid">
                    ...
                    <div class="form-group">
                        <label for="fund_type">Trạng thái</label>
                        @if ($fund->status == App\Constants\Fund::FUND_OK)
                        <div class="alert alert-success">{{App\Constants\Fund::FUND_STATUS[$fund->status]}}</div>
                        @else
                        <div class="alert alert-warning">{{App\Constants\Fund::FUND_STATUS[$fund->status]}}</div>
                        @endif
                ...
                <div class="container-fluid">
                    ...
                    <div class="row pt-3">
                        <div class="col-md-3">
                            <a href="{{route('family_member.funds')}}" class="btn btn-secondary"><i class="far fa-long-arrow-left"></i> Quay lại</a>
                        </div>
