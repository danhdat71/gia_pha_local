...
<div class="root-content mypage">
    <div class="container-fluid">
        <div class="head">
            ...
            <div class="right">
                <div class="wrap-input wrap-input-full-name">
                    <input name="full_name" type="text" class="label" value="{{$myInfo->full_name}}">
                    <div class="edit-small"><i class="fas fa-pen"></i></div>
                </div>
                <div class="wrap-input">
                    <input name="role_name" type="text" class="label" value="{{$myInfo->role_name}}">
                    <div class="edit-small"><i class="fas fa-pen"></i></div>
                </div>
                <div class="wrap-input">
                    <span>Sinh nhật: </span>
                    <div class="d-flex align-items-center">
                        <input type="text" class="input-birthday" maxlength="2" name="born_day" value="{{$myInfo->born_day}}">
                        <span class="divide">/</span>
                        <input type="text" class="input-birthday" maxlength="2" name="born_month" value="{{$myInfo->born_month}}">
                        <span class="divide">/</span>
                        <input type="text" class="input-birthday" maxlength="4" name="born_year" value="{{$myInfo->born_year}}">
                    </div>
                    <div class="edit-small"><i class="fas fa-pen"></i></div>
                </div>
                {{-- <div
                ...
                >
                    ...
                    <input
                        name="leaveday"
                        @if ($myInfo->userInfo->leaveday == null)
                        style="opacity:0.2;"
                        @endif
                        type="text"
                        class="label leaveday"
                        value="{{date('d-m-Y', strtotime($myInfo->userInfo->leaveday))}}"
                    >
                    <div class="edit-small"><i class="fas fa-pen"></i></div>
                </div> --}}
            </div>
        ...
        <div class="wrap-input mb-3">
            ...
            <input name="phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" type="text" class="label" value="{{$myInfo->phone}}">
            <div class="edit-small"><i class="fas fa-pen"></i></div>
        </div>
        <div class="wrap-input mb-3">
            <b class="label-left"><span class="icon"><i class="fas fa-map-marked"></i></span> Địa chỉ:</b>
            <input name="address" type="text" class="label" value="{{$myInfo->address}}">
            <div class="edit-small"><i class="fas fa-pen"></i></div>
        </div>
        <div class="wrap-input mb-3">
            <b class="label-left"><span class="icon"><i class="far fa-address-card"></i></span> Nguyên quán:</b>
            <input name="domicile" type="text" class="label" value="{{$myInfo->domicile}}">
            <div class="edit-small"><i class="fas fa-pen"></i></div>
        </div>
        <div class="wrap-input mb-3">
            <b class="label-left"><span class="icon"><i class="far fa-id-card"></i></span> Căn cước:</b>
            <input name="cccd_number" type="text" class="label" value="{{$myInfo->cccd_number}}">
            <div class="edit-small"><i class="fas fa-pen"></i></div>
        </div>
        ...
        <div class="wrap-input mb-3">
            ...
            <input name="job" type="text" class="label" value="{{$myInfo->userInfo->job}}">
            <div class="edit-small"><i class="fas fa-pen"></i></div>
        </div>
        <div class="wrap-input mb-3">
            <b class="label-left"><span class="icon"><i class="fas fa-user-tag"></i></span> Chức vụ:</b>
            <input name="position" type="text" class="label" value="{{$myInfo->userInfo->position}}">
            <div class="edit-small"><i class="fas fa-pen"></i></div>
        </div>
        <div class="wrap-input mb-3">
            <b class="label-left"><span class="icon"><i class="fas fa-building"></i></span> Tổ chức:</b>
            <input name="organization" type="text" class="label" value="{{$myInfo->userInfo->organization}}">
            <div class="edit-small"><i class="fas fa-pen"></i></div>
        </div>
        <div class="wrap-input mb-3">
            <b class="label-left"><span class="icon"><i class="fas fa-tombstone-alt"></i></span> Nơi an nghỉ:</b>
            <input name="rest_place" type="text" class="label" value="{{$myInfo->userInfo->rest_place}}">
            <div class="edit-small"><i class="fas fa-pen"></i></div>
        </div>
        ...
        <div class="wrap-image-list cert-images">
            ...
            <div data-image-name="{{$image}}" class="wrap-image-main">
                <div class="item-image">
                    <img src="{{route('get_cert_image', $image)}}" alt="">
                </div>
        ...
        <div class="wrap-image-list rest-images">
            ...
            <div data-image-name="{{$image}}" class="wrap-image-main">
                <div class="item-image">
                    <img src="{{route('get_rest_image', $image)}}" alt="">
                </div>
                <div class="remove"><i class="far fa-times"></i></div>
            </div>
            @endforeach
