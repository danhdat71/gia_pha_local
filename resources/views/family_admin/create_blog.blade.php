...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <form id="create-blog" action="{{route('family_admin.create_event')}}" class="row" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input
                                ...
                                accept="image/*"
                            >
                            <label for="avatar"><div class="preview-img mt-3"><img src="img/fixed/default_blog.png" alt=""></div></label>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="d-flex">
                                <div class="item pr-3">
                                    ...
                                    <input value="0" type="radio" id="is_not_visible" name="is_visible">
                                </div>
                                <div class="item">
                                    <label for="is_visible">Hiện</label>
                                    <input checked value="1" type="radio" id="is_visible" name="is_visible">
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 pt-3 text-center">
                            <button id="upload" class="btn btn-success btn-lg">Tạo mới</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        $('#upload').click(function(e){
            ...
            $.ajax({
                url: "{{ route('family_admin.create_blog') }}",
                type: 'POST',
                data: formData,
                cache : false,
                processData: false,
