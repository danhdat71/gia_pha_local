...
@section('content')
                        ...
                        <form action="" id="form-store-vr-3d">
                            <div class="row pb-2">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control" accept=".glb">
                            ...
                            <div class="row pb-2">
                                <div class="col-md-7">
                                    <div id="wrap-button" class="scroll-bar-1">
                                        {{-- <div class="wrap-button-option">
                                            <div class="form-group">
                                                <label for="">Tên nút <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Tọa độ X <span class="text-danger">*</span></label>
                                                <input type="range" class="form-control" min="-1" max="1" step="0.000000001">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Tọa độ Y <span class="text-danger">*</span></label>
                                                <input type="range" class="form-control" min="-1" max="1" step="0.000000001">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Tọa độ Z <span class="text-danger">*</span></label>
                                                <input type="range" class="form-control" min="-1" max="1" step="0.000000001">
                                            </div>
                                            <div class="form-group">
                                                <label for="">Ngữ cảnh cần dịch chuyển tới <span class="text-danger">*</span></label>
                                                <select name="" id="" class="form-control">
                                                    <option value="">Ngữ cảnh 1</option>
                                                    <option value="">Ngữ cảnh 2</option>
                                                </select>
                                            </div>
                            ...
                            <div class="row pt-4">
                                <div class="col-md-12 text-right">
                                    <a href="{{route('family_admin.index_vr_3d', $user_id)}}" class="btn btn-secondary"><i class="fas fa-long-arrow-alt-left"></i> Quay lại</a>
                                    <button class="btn button-color-template" id="submit-save-all-btn" disabled>Lưu toàn bộ</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        submitSave.click(function(e){
            ...
            $('.err_msg').text('');
            $.ajax({
                url: "{{ route('family_admin.store_vr_3d', $user_id) }}",
                type: 'POST',
                data: formData,
                cache : false,
                processData: false,
