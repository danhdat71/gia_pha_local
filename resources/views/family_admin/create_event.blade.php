...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-header card-header-template">Tạo sự kiện</div>
                <div class="card-body">
                    <form action="{{route('family_admin.create_event')}}" class="row" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input
                                ...
                                id="date"
                                @if (old('date') != '')
                                value="{{date('d-m-Y', strtotime(old('date')))}}"
                                @else
                                value="{{date('d-m-Y')}}"
                                @endif
                                autocomplete="off"
                        ...
                        <div class="col-md-12 pt-3 text-right">
                            <button class="btn button-color-template">Tạo mới sự kiện</button>
                        </div>
                    </form>
                </div>
            </div>
